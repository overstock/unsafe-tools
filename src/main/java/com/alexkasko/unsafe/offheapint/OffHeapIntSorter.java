...
public class OffHeapIntSorter {
     ...
     */
    public static void sort(OffHeapIntAddressable a) {
        sort(a, 0, a.size());
    }
     ...
     */
    public static void sort(OffHeapIntAddressable a, long fromIndex, long toIndex) {
     ...
     */
    public static void sort(OffHeapIntAddressable a, OffHeapIntComparator comp) {
     ...
     * @throws IllegalArgumentException {@code if (fromIndex < 0 || fromIndex > toIndex || toIndex > a.size())}
     */
    public static void sort(OffHeapIntAddressable a, long fromIndex, long toIndex, OffHeapIntComparator comp) {
        if (fromIndex < 0 || fromIndex > toIndex || toIndex > a.size()) {
            throw new IllegalArgumentException("Illegal input, collection size: [" + a.size() + "], " +
                    "fromIndex: [" + fromIndex + "], toIndex: [" + toIndex + "]");
        }
        doSortWithComparator(a, fromIndex, toIndex - 1, new IntComp(comp));
    }
     ...
     */
    private static void doSort(OffHeapIntAddressable a, long left, long right) {
     ...
     * @param right the index of the last element, inclusive, to be sorted
     */
    private static void dualPivotQuicksort(OffHeapIntAddressable a, long left, long right) {
        ...
        int ae1 = a.get(e1), ae2 = a.get(e2), ae3 = a.get(e3), ae4 = a.get(e4), ae5 = a.get(e5);
         ...
         */
        int pivot1 = ae2; a.set(e2, a.get(left));
        int pivot2 = ae4; a.set(e4, a.get(right));
     ...
     * @param comp  comparator that defines sort order
     */
    private static void doSortWithComparator(OffHeapIntAddressable a, long left, long right, IntComp comp) {
        // Use insertion sort on tiny arrays
        if (right - left + 1 < INSERTION_SORT_THRESHOLD) {
            for (long i = left + 1; i <= right; i++) {
                int ai = a.get(i);
      ...
      * @param comp  comparator that defines sort order
      */
    private static void dualPivotQuicksortWithComparator(OffHeapIntAddressable a, long left, long right, IntComp comp) {
        // Compute indices of five evenly spaced elements
        long sixth = (right - left + 1) / 6;
        long e1 = left  + sixth;
        long e5 = right - sixth;
        ...
        if (comp.gt(ae1, ae2)) { int t = ae1; ae1 = ae2; ae2 = t; }
        if (comp.gt(ae4, ae5)) { int t = ae4; ae4 = ae5; ae5 = t; }
        if (comp.gt(ae1, ae3)) { int t = ae1; ae1 = ae3; ae3 = t; }
        if (comp.gt(ae2, ae3)) { int t = ae2; ae2 = ae3; ae3 = t; }
        if (comp.gt(ae1, ae4)) { int t = ae1; ae1 = ae4; ae4 = t; }
        if (comp.gt(ae3, ae4)) { int t = ae3; ae3 = ae4; ae4 = t; }
        if (comp.gt(ae2, ae5)) { int t = ae2; ae2 = ae5; ae5 = t; }
        if (comp.gt(ae2, ae3)) { int t = ae2; ae2 = ae3; ae3 = t; }
        if (comp.gt(ae4, ae5)) { int t = ae4; ae4 = ae5; ae5 = t; }
    ...
    private static class IntComp {
        final OffHeapIntComparator comp;

        IntComp(OffHeapIntComparator comp) {
            this.comp = comp;
        }

        boolean gt(int l1, int l2) {
            return comp.compare(l1, l2) > 0;
        }

        boolean lt(int l1, int l2) {
            return comp.compare(l1, l2) < 0;
        }
